 ...
 */
 function typewrite()
 {
     let str="To 聪聪：<--真的不容易，终于来到了这个页面。前面种种，总给我一种送你满是情话的贺卡一般的感觉，粗略的统计了一下，前面的26段话一半儿来源百度知乎，一半儿都是我在发牢骚，哎，不扯了不扯了。现在，终于可以好好说说心里话了。<--先来说说你给我的感觉吧，乐观开朗，极擅言谈的一个小姑娘，而这种性格，是我可望而不可及的。而我呢，不善交流，给人一种不好相处的感觉。但是，我感觉我好像有些变了，脸上多了笑容，也变的逐渐会分享。其实在我的眼里，你在任何时候，任何地方，都会闪闪发光！我始终不会忘记，你会记得我说过的一些话，也了解我的口味；而我也会记得，你喜欢阳光，喜欢星空，喜欢推理悬疑，喜欢吃喝玩儿乐等等等等，而我也想过，或送你一颗星，又或送你一本书，再或者是一本插画集，但是，最终选择了这个方案，或许，这就是一个理工男孩儿的浪漫吧。（PS:虽然框架来源于B站，但是，我做了一些改动。）另外，很多个第一次在你的身上实现，第一次游戏开麦，第一次对着你抱着吉他唱歌（PS:虽然很烂，但是也算！），第一次的当众演出，当然，也包括第一次的表白…好了，该说的就先这么多吧，这里的这句话我觉得特别好——我愿意为你，写满整个世界的情诗，因为我喜欢你，因为…我也想给你哪怕一点点的浪漫，因为当代码不止是代码的时候，它就有了新的意义。<--那么，郭聪聪同学，我想要带你玩儿遍祖国的大好河山，陪你去体验不同地方的特色美食，和你一同努力进步，我还想要与你共同实现更多的第一次……我们，在一起吧？";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
